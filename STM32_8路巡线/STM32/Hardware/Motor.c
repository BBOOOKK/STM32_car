...
void Move_control(int l_pwm,int r_pwm)
{
    ...
    r_pwm = int_protect(r_pwm, 2000, -2000);

    /* 2. 左电机 (PWM_ENA + INA1/INA2) -> 对应 PB15/PB14 */
    if (l_pwm >= 0)
    {
        // 正转：INA_1 = 0, INA_2 = 1
        GPIO_ResetBits(GPIOB, GPIO_Pin_15); // INA_1
        GPIO_SetBits(GPIOB,   GPIO_Pin_14); // INA_2
    ...
    {
        // 正转：INB_1 = 0, INB_2 = 1
        GPIO_SetBits(GPIOB, GPIO_Pin_13); // INB_1
        GPIO_ResetBits(GPIOB,   GPIO_Pin_12); // INB_2
