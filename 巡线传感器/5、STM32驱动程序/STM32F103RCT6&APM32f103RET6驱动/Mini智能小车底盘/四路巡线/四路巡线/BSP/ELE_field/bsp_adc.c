...
int Sensor_Left,Sensor_Right,Sensor_Middle;
...
void getEleData(void)
{
	...
	Sensor_Right=Get_Adc(5);               //采集右边电感的数据
	Sensor_Middle=Get_Adc(4);              //采集中间电感的数据
}
...
void EleDataDeal(void)
{
	...
	LCD_ShowString(0,60,(u8*)ele_data,BLACK,WHITE,16,0);
